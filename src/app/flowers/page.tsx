    ...
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        <header className="mb-12">
          ...
          <p className="text-xl text-[#8B95A1]">Copy 55+ flower and nature symbols including decorative flowers ✿ ❀, emoji flowers 🌸 🌹, leaves, plants, and botanical elements. Perfect for creative designs, nature projects, and decorative content.</p>
        </header>
        ...
        <section className="mb-16">
          ...
          <p className="text-[#8B95A1] mb-6">Ornamental flower symbols perfect for borders and decorative designs</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-[#8B95A1] mb-6">Beautiful flower emoji in various colors and styles</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-[#8B95A1] mb-6">Leaf and foliage symbols for botanical and nature themes</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-[#8B95A1] mb-6">Tree and plant emoji for nature-themed designs and content</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-[#8B95A1] mb-6">Geometric and star-like flower variations</p>
