    ...
    <div className="min-h-screen bg-gradient-to-b from-cyan-50 to-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        <header className="mb-12">
          ...
          <p className="text-xl text-gray-300">Copy 60+ weather symbols including sun ☀, clouds ☁, rain ☔, snow ❄, moon phases, rainbows 🌈, and atmospheric effects. Perfect for weather apps, forecasts, and climate content.</p>
        </header>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Bright sun symbols for clear weather and sunny days</p>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-sm bg-gray-100 text-gray-300 px-3 py-1 rounded-full">{cloudSymbols.length} symbols</span>
          </div>
          <p className="text-gray-400 mb-6">Cloud symbols representing partly cloudy, overcast, and stormy conditions</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Rain and water drop symbols for rainy weather conditions</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Snowflake and snow symbols for winter weather conditions</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Wind and breeze symbols for windy conditions</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Moon phases and star symbols for night sky representation</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Water, waves, and rainbow symbols for oceanic and atmospheric elements</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Specialized weather symbols including comet, temperature, and fire</p>
