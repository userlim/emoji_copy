    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        <header className="mb-12">
          ...
          <p className="text-xl text-gray-300">Copy 당구장 기호 (reference marks), daggers, asterisks, section signs, and special text symbols. Perfect for citations, footnotes, and decorative text.</p>
        </header>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Universal reference marks including the iconic ※ (당구장 기호) used in Korean and Japanese typography</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Dagger symbols (obelus) traditionally used for footnotes and annotations in documents</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Section signs (pilcrow), paragraph marks, and musical notation symbols used in legal and academic documents</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Special punctuation marks, quotation variants, and typographic ornaments</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Copyright, trademark, registered, and other legal/technical symbols</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Decorative dingbat symbols, ornamental marks, and fancy text decorations</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Specialized reference marks and enclosed characters used in Korean, Chinese, and Japanese typography</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Numbers enclosed in circles, useful for lists, rankings, and numbered items</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Uppercase letters enclosed in circles for categorization and highlighting</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Lowercase letters enclosed in circles for modern and creative text decoration</p>
