    ...
    <main className="min-h-screen bg-gradient-to-br from-yellow-50 to-amber-50 py-12">
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-300">Copy and paste currency symbols from around the world. Find dollar signs, euros, pounds, yen, bitcoin, and international money symbols.</p>
        </div>
        ...
        <div className="mt-16 bg-white/[0.03] rounded-lg shadow-md p-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-300">These are the same symbol - the dollar sign. The slight visual variations depend on your font or device. Both represent US dollars and most other dollar currencies.</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-100 mb-2">Which currency symbol should I use for which country?</h3>
              <p className="text-gray-300">The $ symbol is used for US dollars, Canadian dollars, and many other countries. € is for the Euro, £ for British pounds, ¥ for Japanese yen, and so on. Use the official symbol of the currency you're referencing.</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-100 mb-2">Can I use currency symbols in social media?</h3>
              <p className="text-gray-300">Yes! Currency symbols work on all social media platforms, messaging apps, and most websites. They're great for posts about pricing, financial content, and business topics.</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-100 mb-2">What is the Bitcoin symbol?</h3>
              <p className="text-gray-300">The Bitcoin symbol is ₿. It's a standard Unicode character and represents Bitcoin (BTC). You can also see it displayed as 🪙 in emoji form.</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-100 mb-2">Are all these symbols widely supported?</h3>
              <p className="text-gray-300">Most currency symbols are widely supported across devices and applications. Some less common ones may not display on older devices, but the major currencies ($, €, £, ¥, ₿) work everywhere.</p>
            </div>
          </div>
        </div>
      </div>
