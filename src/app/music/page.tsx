    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        <header className="mb-12">
          ...
          <p className="text-xl text-[#8B95A1]">Copy 50+ music symbols including musical notes ♪ ♫, staff notation ♯ ♭, instruments 🎸 🎹, and audio controls. Perfect for music projects, documents, and social media.</p>
        </header>
        ...
        <section className="mb-16">
          ...
          <p className="text-[#8B95A1] mb-6">Musical note symbols and staff notation including accidentals and clefs</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-[#8B95A1] mb-6">Different musical note values from whole notes to sixteenth notes</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-[#8B95A1] mb-6">Rest symbols representing silence in musical notation</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-[#8B95A1] mb-6">Musical instrument emoji for all major instrument types</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-[#8B95A1] mb-6">Speaker and sound level indicators for audio representation</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-[#8B95A1] mb-6">Playback control symbols for media players and interfaces</p>
