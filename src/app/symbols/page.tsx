    ...
    <div className="min-h-screen bg-gradient-to-b from-violet-50 to-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        <header className="mb-12">
          ...
          <p className="text-xl text-gray-300">Copy 100+ special symbols including card suits ♠ ♣ ♥ ♦, zodiac signs, chess pieces ♔ ♕, gender symbols ♀ ♂, religious symbols ✝, warning signs ⚠, and more. Perfect for documents, designs, and specialized content.</p>
        </header>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Playing card suit symbols in filled and outlined variants</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">All twelve zodiac constellation symbols plus Ophiuchus</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">White and black chess piece symbols for all six piece types</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Gender and sexuality symbols for inclusive representation</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Sacred and religious symbols from various world faiths and traditions</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Warning, hazard, and alert symbols for caution and danger indication</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Special purpose symbols including peace, recycling, electricity, and more</p>
