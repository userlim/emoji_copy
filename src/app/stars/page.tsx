    ...
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-white">
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        <header className="mb-12">
          ...
          <p className="text-xl text-gray-300">Copy 100+ star symbols, sparkle effects, and decorative star designs. Perfect for ratings, highlights, and creative text decorations.</p>
        </header>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Standard star and sparkle emojis with various styles</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Text-based star symbols that work across all devices and platforms</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Decorative sparkle, snowflake, and ornamental star designs</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Various filled and outlined star designs with different styles</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-400 mb-6">Popular star combinations ready to copy and paste</p>
