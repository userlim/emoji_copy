      ...
      <body className="min-h-screen flex flex-col">
        <header className="border-b border-[#F2F4F6] bg-white">
          <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <span className="text-sm text-[#8B95A1]">Click to copy!</span>
          </div>
        </header>
        ...
        <footer className="border-t border-[#E5E8EB] py-6 text-center text-sm text-[#4E5968] bg-white/20 backdrop-blur-sm">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-3">
              <span className="text-xs text-[#4E5968] font-semibold uppercase tracking-wider">Related Free Tools:</span>
                <a href="https://meme-archive-self.vercel.app" target="_blank" rel="noopener noreferrer" className="text-[#8B95A1] hover:text-[#191F28] transition-colors text-xs">Meme Archive Browser</a>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-3">
            <a href="/privacy-policy" className="text-[#8B95A1] hover:text-[#191F28] transition-colors text-xs">
              Privacy Policy
            </a>
            <a href="/terms" className="text-[#8B95A1] hover:text-[#191F28] transition-colors text-xs">
              Terms of Service
            </a>
          </div>
