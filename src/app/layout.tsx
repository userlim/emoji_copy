...
export const metadata: Metadata = {
  ...
  description: 'Copy and paste emojis, arrows, symbols and special characters with one click. The most complete free emoji library — arrows ↑↓←→, hearts ❤️, smileys 😊, hands 👍, and 1000+ more.',
    ...
    <html lang="en">
      ...
      <body className="min-h-screen flex flex-col">
        ...
        <footer className="border-t border-gray-200 py-4 text-center text-sm text-gray-400">
          © 2026 EmojiCopy. All emojis are Unicode standard.
        </footer>
      </body>
    </html>
  )
